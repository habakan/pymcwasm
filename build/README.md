...
needs PyMC and Node, and asking that of someone who wants to see the thing run
...
instruction file; `build_artifact.py` runs npm's tapewasm over it, as `pymcwasm-build` does, and records
